...
>> Python 3. Even though I'm used to Python 2, I'm trying to get familiar with 3 to complete the HackerRank pre-work.

### Q2. Which Python Version Installed   

How can you check the version of Python installed if you happen to be on an unfamiliar computer?

>> From the command line, run `python --version`.
